...
package com.ajs.service.ws;

public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.ajs.service.ws.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8085/services/HelloWorld";
    ...
    public com.ajs.service.ws.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public com.ajs.service.ws.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ajs.service.ws.HelloWorldSoapBindingStub _stub = new com.ajs.service.ws.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ajs.service.ws.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ajs.service.ws.HelloWorldSoapBindingStub _stub = new com.ajs.service.ws.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
