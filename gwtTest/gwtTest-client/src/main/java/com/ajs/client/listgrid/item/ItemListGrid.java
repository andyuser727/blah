...
public class ItemListGrid extends ListGrid {
    ...
    public ItemListGrid(boolean attachedToInvoice, boolean attachedToQuote, boolean attachedToCustomerOrder) {
        ...
        if (attachedToInvoice) {
            ...
            setFields(itemCode, itemName, itemDescription, amount);
        }
    }
}
